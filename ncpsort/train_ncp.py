...
from ncpsort.models.trainer_model import NeuralClustering  # same cluster proportion across batch
...
def get_data_generator(params, data_config):
    ...
    templates_upsampled = \
        create_upsampled_templates(templates, idx_templates, selected_chans, upsample=data_config['temp_upsample'])
