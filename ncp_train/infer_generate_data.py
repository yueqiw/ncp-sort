...
# --channel_end_idx 1000 --do_corner_padding
# --global_end_idx 90781 (first one minute) --do_corner_padding
...
infer_params['voltage_file'] = '/Volumes/IMEC_ph3/standardized.bin'
