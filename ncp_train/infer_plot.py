...
# python infer_49ch_non_triaged_plot.py xxx --min_cls_size 50 --n_seeds 1 --plot_mfm --plot_type overlay
# python infer_49ch_non_triaged_plot.py xxx --min_cls_size 50 --n_seeds 1 --plot_mfm --plot_type tsne 
...
if templates_name == "yass-190322":
    ...
    infer_params['template_file'] = os.path.expanduser("~/Dropbox/lib/discrete_neural_process/data/data_190430_non-triaged_and_kilosort/kilosort2/templates_reloaded.npy")
